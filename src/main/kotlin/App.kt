...
fun main(args: Array<String>) {
	...
	println("A = ${ab.first.format(3)} B = ${ab.second.format(3)}")

	println();

	val ab2 = lsMethod.getAB()
	println(lsMethod)
	println("A = ${ab2.first.format(3)} B = ${ab2.second.format(3)}")
